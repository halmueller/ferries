...
class SectionedVesselsTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SectionedVesselsCell", for: indexPath)
        let event = fetchedResultsController.object(at: indexPath)
        configureCell(cell, withVessel: event)
        return cell
    }
    ...
    var fetchedResultsController: NSFetchedResultsController<Vessel> {
        ...
        let classSortDescriptor = NSSortDescriptor(key: "ferryClass.ferryClassName", ascending: true)
        ...
        let aFetchedResultsController =
            NSFetchedResultsController(fetchRequest: fetchRequest,
                                       ...
                                       sectionNameKeyPath: "ferryClass.ferryClassName",
                                       cacheName: nil)
